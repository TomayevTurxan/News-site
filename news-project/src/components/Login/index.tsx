...
import userSlices, { setUsers } from "../../reduxTol0kit/userSlices/usersSlice";
...
export default function Login() {
  const dispatch = useDispatch({userSlices,userSlice});
    ...
    <div className={style.login}>
      <div className="col-md-6">
        <ThemeProvider theme={defaultTheme}>
          <Container component="main" className="col-md-6">
            <Box
              sx={{
                display: "flex",
